...
** How to fast apply a function over a ragged array?
   ...
   #+begin_src R
     ...
     ## f0(x, f)  407.464  415.873  428.9751  420.9835  426.0235  4896.238 10000
     ## f1(x, f)  474.577  486.841  503.4230  493.4610  499.5985  3071.205 10000
     ## f2(x, f) 1380.378 1436.882 1493.5056 1454.6915 1471.6040 27627.855 10000
     ...
     f2 <- function(x, f) { by(x, f, mean) }

     bench <- microbenchmark::microbenchmark(
				f0(x, f), f1(x, f), f2(x, f),
				times = 1E4)
